...
<body>
    ...
    <!-- تم نقل زر التثبيت إلى المحتوى، لم نعد نحتاج partial منفصل -->
    
    <!-- CSS لتجنب تضارب مع شريط التثبيت الجديد -->
    <style>
        /* التأكد من أن زر أضف منشور لا يتضارب مع شريط التثبيت */
        body.has-install-bar .floating-add-btn {
            bottom: 100px !important; /* مساحة إضافية فوق شريط التثبيت */
        }
        
        /* تحسين المظهر العام للمحتوى مع شريط التثبيت */
        body.has-install-bar .container {
            margin-bottom: 20px;
        }
